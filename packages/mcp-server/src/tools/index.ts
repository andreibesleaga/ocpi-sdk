...
import retrieve_evse_number_2_2_sender_ocpi_locations from './ocpi/sender/number-2-2/locations/retrieve-evse-number-2-2-sender-ocpi-locations';
import retrieve_page_number_2_2_sender_ocpi_locations from './ocpi/sender/number-2-2/locations/retrieve-page-number-2-2-sender-ocpi-locations';
...
import modify_number_2_2_receiver_ocpi_locations from './ocpi/receiver/number-2-2/locations/modify-number-2-2-receiver-ocpi-locations';
import modify_evse_number_2_2_receiver_ocpi_locations from './ocpi/receiver/number-2-2/locations/modify-evse-number-2-2-receiver-ocpi-locations';
import retrieve_evse_number_2_2_receiver_ocpi_locations from './ocpi/receiver/number-2-2/locations/retrieve-evse-number-2-2-receiver-ocpi-locations';
import update_connector_number_2_2_receiver_ocpi_locations from './ocpi/receiver/number-2-2/locations/update-connector-number-2-2-receiver-ocpi-locations';
import update_evse_number_2_2_receiver_ocpi_locations from './ocpi/receiver/number-2-2/locations/update-evse-number-2-2-receiver-ocpi-locations';
...
addEndpoint(retrieve_evse_number_2_2_sender_ocpi_locations);
addEndpoint(retrieve_page_number_2_2_sender_ocpi_locations);
...
addEndpoint(modify_number_2_2_receiver_ocpi_locations);
addEndpoint(modify_evse_number_2_2_receiver_ocpi_locations);
addEndpoint(retrieve_evse_number_2_2_receiver_ocpi_locations);
addEndpoint(update_connector_number_2_2_receiver_ocpi_locations);
addEndpoint(update_evse_number_2_2_receiver_ocpi_locations);
