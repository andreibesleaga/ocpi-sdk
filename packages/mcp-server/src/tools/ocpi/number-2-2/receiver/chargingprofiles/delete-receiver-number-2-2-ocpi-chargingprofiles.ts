...
export const tool: Tool = {
  name: 'delete_receiver_number_2_2_ocpi_chargingprofiles',
  description:
...
export const handler = async (client: OcpiSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asBinaryContentResult(await client.ocpi.number2_2.receiver.chargingprofiles.delete(sessionId, body));
};
