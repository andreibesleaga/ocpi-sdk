...
export const tool: Tool = {
  name: 'modify_evse_number_2_2_receiver_ocpi_locations',
  description:
...
export const handler = async (client: OcpiSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asBinaryContentResult(await client.ocpi.receiver.number2_2.locations.modifyEvse(evseUID, body));
};
