...
export const tool: Tool = {
  name: 'cancel_reservation_number_2_2_receiver_ocpi_commands',
  description:
...
export const handler = async (client: OcpiSDK, args: Record<string, unknown> | undefined) => {
  ...
  return asBinaryContentResult(await client.ocpi.receiver.number2_2.commands.cancelReservation(body));
};
