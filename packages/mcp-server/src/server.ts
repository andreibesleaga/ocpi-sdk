...
import { ClientOptions } from 'ocpi-sdk';
...
export { ClientOptions } from 'ocpi-sdk';
...
export function initMcpServer(params: {
  ...
  const client = new OcpiSDK(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new OcpiSDK({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
