...
export class Tokens extends APIResource {
  retrieve(uid: string, params: TokenRetrieveParams, options?: RequestOptions): APIPromise<Response> {
    const {
    ...
    return this._client.get(path`/ocpi/sender/2.2/tokens/page/${uid}`, {
      ...options,
  ...
  list(params: TokenListParams, options?: RequestOptions): APIPromise<Response> {
    const {
      'OCPI-from-country-code': ocpiFromCountryCode,
      'OCPI-from-party-id': ocpiFromPartyID,
      'OCPI-to-country-code': ocpiToCountryCode,
    ...
    return this._client.get('/ocpi/sender/2.2/tokens', {
      query,
      ...options,
      headers: buildHeaders([
        {
  ...
  authorize(tokenUid: string, params: TokenAuthorizeParams, options?: RequestOptions): APIPromise<Response> {
    const {
      'OCPI-from-country-code': ocpiFromCountryCode,
      'OCPI-from-party-id': ocpiFromPartyID,
      'OCPI-to-country-code': ocpiToCountryCode,
    ...
    return this._client.post(path`/ocpi/sender/2.2/tokens/${tokenUid}/authorize`, {
      query: { type },
      body,
      ...options,
      headers: buildHeaders([
