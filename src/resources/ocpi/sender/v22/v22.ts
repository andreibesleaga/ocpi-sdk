...
export class V22 extends APIResource {
  ...
  update(uid: string, params: V22UpdateParams, options?: RequestOptions): APIPromise<Response> {
    const {
      command,
...
export interface V22UpdateParams {
  /**
   * Path param:
   */
...
export declare namespace V22 {
  export { type DisplayText as DisplayText, type V22UpdateParams as V22UpdateParams };
