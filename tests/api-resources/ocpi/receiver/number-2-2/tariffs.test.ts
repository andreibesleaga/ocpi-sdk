...
describe('resource tariffs', () => {
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.tariffs.retrieve('tariffID', {
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.tariffs.update('tariffID', {
      countryCode: 'countryCode',
      partyID: 'partyID',
      id: 'id',
  ...
  test.skip('delete: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.tariffs.delete('tariffID', {
      countryCode: 'countryCode',
      partyID: 'partyID',
      'OCPI-from-country-code': 'OCPI-from-country-code',
      'OCPI-from-party-id': 'OCPI-from-party-id',
