...
describe('resource locations', () => {
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.locations.retrieve('locationID', {
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.locations.update('locationID', {
      countryCode: 'countryCode',
      partyID: 'partyID',
      id: 'id',
      address: 'address',
