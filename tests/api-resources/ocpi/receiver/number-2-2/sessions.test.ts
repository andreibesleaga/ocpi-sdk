...
describe('resource sessions', () => {
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.sessions.retrieve('sessionID', {
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.ocpi.receiver.number2_2.sessions.update('sessionID', {
      countryCode: 'countryCode',
      partyID: 'partyID',
      body: { foo: {} },
      'OCPI-from-country-code': 'OCPI-from-country-code',
