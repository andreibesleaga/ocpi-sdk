...
describe('resource sessions', () => {
  ...
  test.skip('retrieve: required and optional params', async () => {
    const response = await client.ocpi.sender.number2_2.sessions.retrieve('uid', {
  ...
  test.skip('list: required and optional params', async () => {
    const response = await client.ocpi.sender.number2_2.sessions.list({
      'OCPI-from-country-code': 'OCPI-from-country-code',
      'OCPI-from-party-id': 'OCPI-from-party-id',
      'OCPI-to-country-code': 'OCPI-to-country-code',
      'OCPI-to-party-id': 'OCPI-to-party-id',
  ...
  test.skip('updateChargingPreferences: required and optional params', async () => {
    const response = await client.ocpi.sender.number2_2.sessions.updateChargingPreferences('sessionID', {
      profile_type: 'CHEAP',
      'OCPI-from-country-code': 'OCPI-from-country-code',
      'OCPI-from-party-id': 'OCPI-from-party-id',
      'OCPI-to-country-code': 'OCPI-to-country-code',
