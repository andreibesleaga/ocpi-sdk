...
describe('resource chargingprofiles', () => {
  ...
  test.skip('update: required and optional params', async () => {
    const response = await client.ocpi.number2_2.sender.chargingprofiles.update('sessionId', {
      charging_profile: {
  ...
  test.skip('createResult: required and optional params', async () => {
    const response = await client.ocpi.number2_2.sender.chargingprofiles.createResult('uid', {
      result: 'ACCEPTED',
      'OCPI-from-country-code': 'OCPI-from-country-code',
      'OCPI-from-party-id': 'OCPI-from-party-id',
      'OCPI-to-country-code': 'OCPI-to-country-code',
